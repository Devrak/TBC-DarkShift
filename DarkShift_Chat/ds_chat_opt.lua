...
function ds_chat_optionsBuild()
	...
	opt.o6 = ds_CustomBg(opt,336,655,10,1052)
	...
	-- Emoji
	ds_DescString("seemsgoodman / sgman",opt.o6,15,99,9)
	opt.o6e1 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e1:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -110)
	opt.o6e1:SetWidth(32)
	opt.o6e1:SetHeight(32)
	opt.o6e1:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\SeemsGoodMan.tga")
	
	ds_DescString("feelsgoodman / fgman",opt.o6,165,99,9)
	opt.o6e2 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e2:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -112)
	opt.o6e2:SetWidth(32)
	opt.o6e2:SetHeight(32)
	opt.o6e2:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\FeelsGoodMan.tga")
	
	ds_DescString("feelsbadmn / fbman",opt.o6,15,154,9)
	opt.o6e3 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e3:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -165)
	opt.o6e3:SetWidth(32)
	opt.o6e3:SetHeight(32)
	opt.o6e3:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\FeelsBadMan.tga")
	
	ds_DescString("Ree / REE",opt.o6,165,154,9)
	opt.o6e4 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e4:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -165)
	opt.o6e4:SetWidth(32)
	opt.o6e4:SetHeight(32)
	opt.o6e4:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Ree.tga")
	
	ds_DescString("LUL / lul",opt.o6,15,209,9)
	opt.o6e5 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e5:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -220)
	opt.o6e5:SetWidth(32)
	opt.o6e5:SetHeight(32)
	opt.o6e5:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\lul.tga")
	
	ds_DescString("OMEGALUL / omegalul",opt.o6,165,209,9)
	opt.o6e6 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e6:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -220)
	opt.o6e6:SetWidth(32)
	opt.o6e6:SetHeight(32)
	opt.o6e6:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Omega.tga")
	
	ds_DescString("MonkaS / monkas",opt.o6,15,264,9)
	opt.o6e7 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e7:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -275)
	opt.o6e7:SetWidth(32)
	opt.o6e7:SetHeight(32)
	opt.o6e7:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\MonkaS.tga")
	
	ds_DescString("WeSmart / wesmart",opt.o6,165,264,9)
	opt.o6e8 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e8:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -275)
	opt.o6e8:SetWidth(32)
	opt.o6e8:SetHeight(32)
	opt.o6e8:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\WeSmart.tga")
	
	ds_DescString("PogChamp / pogchamp",opt.o6,15,319,9)
	opt.o6e9 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e9:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -331)
	opt.o6e9:SetWidth(32)
	opt.o6e9:SetHeight(32)
	opt.o6e9:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PogChamp.tga")
	
	ds_DescString("Poggers / poggers",opt.o6,165,319,9)
	opt.o6eA = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eA:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -331)
	opt.o6eA:SetWidth(32)
	opt.o6eA:SetHeight(32)
	opt.o6eA:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Poggers.tga")
	
	ds_DescString("PEP",opt.o6,15,374,9)
	opt.o6eB = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eB:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -385)
	opt.o6eB:SetWidth(32)
	opt.o6eB:SetHeight(32)
	opt.o6eB:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Pep.tga")
	
	ds_DescString("PepeHands / pepehands",opt.o6,165,374,9)
	opt.o6eC = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eC:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -385)
	opt.o6eC:SetWidth(32)
	opt.o6eC:SetHeight(32)
	opt.o6eC:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PepeHands.tga")
	
	ds_DescString("AYY / ayy",opt.o6,15,429,9)
	opt.o6eD = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eD:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -440)
	opt.o6eD:SetWidth(32)
	opt.o6eD:SetHeight(32)
	opt.o6eD:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\ayy.tga")
	
	ds_DescString("NotLikeThis / notlikethis",opt.o6,165,429,9)
	opt.o6eE = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eE:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -440)
	opt.o6eE:SetWidth(32)
	opt.o6eE:SetHeight(32)
	opt.o6eE:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\NotLikeThis.tga")
	
	ds_DescString("Kappa / kappa",opt.o6,15,484,9)
	opt.o6eF = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eF:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -495)
	opt.o6eF:SetWidth(32)
	opt.o6eF:SetHeight(32)
	opt.o6eF:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Kappa.tga")
	
	ds_DescString("CmonBruh / cmonbruh",opt.o6,165,484,9)
	opt.o6eG = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eG:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -495)
	opt.o6eG:SetWidth(32)
	opt.o6eG:SetHeight(32)
	opt.o6eG:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\CmonBruh.tga")
	
	ds_DescString("Thonk / thonk",opt.o6,15,539,9)
	opt.o6eH = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eH:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -550)
	opt.o6eH:SetWidth(32)
	opt.o6eH:SetHeight(32)
	opt.o6eH:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Thonk.tga")
	
	ds_DescString("Wwow / wwow",opt.o6,165,539,9)
	opt.o6eI = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eI:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -550)
	opt.o6eI:SetWidth(32)
	opt.o6eI:SetHeight(32)
	opt.o6eI:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Wwow.tga")
	
	ds_DescString("PepeEz / pepeez",opt.o6,15,594,9)
	opt.o6eJ = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eJ:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 25, -605)
	opt.o6eJ:SetWidth(32)
	opt.o6eJ:SetHeight(32)
	opt.o6eJ:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PepeEz.tga")
	
	ds_DescString("Facepalm / facepalm",opt.o6,165,594,9)
	opt.o6eK = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eK:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 170, -605)
	opt.o6eK:SetWidth(32)
	opt.o6eK:SetHeight(32)
	opt.o6eK:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Facepalm.tga")
