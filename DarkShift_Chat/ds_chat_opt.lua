...
function ds_chat_optionsBuild()
	...
	-- Slider bg
	ds_chat_opt.sl.bg = ds_chat_opt.sl:CreateTexture(nil,"BACKGROUND")
	ds_chat_opt.sl.bg:SetWidth(19)
	ds_chat_opt.sl.bg:SetHeight(398)
	ds_chat_opt.sl.bg:SetPoint("TOPLEFT",ds_chat_opt.sl,-1,-8)
	ds_chat_opt.sl.bg:SetTexture(0, 0, 0, 0.3)
	
	-- Thumb
	ds_chat_opt.sl.th = ds_chat_opt.sl:CreateTexture(nil,"BACKGROUND")
	ds_chat_opt.sl.th:SetTexture("Interface\\Buttons\\UI-ScrollBar-Knob")
	ds_chat_opt.sl:SetThumbTexture(ds_chat_opt.sl.th)
	...
	UIDropDownMenu_Initialize(opt.o2s1, function()
		local info={}
		for k,v in PairsByKeys(FONTS_LIST) do
			info.text	= k
			info.value	= v
	...
	opt.o5 = ds_CustomBg(opt,336,320,10,699)
	...
	opt.o5s6:SetScript("OnEnterPressed", function()
		...
		-- W
		ChatFrame1:SetWidth(dsc_o5s6:GetText())
		this:ClearFocus()
	end)
	...
	opt.o5s7:SetScript("OnEnterPressed", function()
		...
		-- H
		ChatFrame1:SetHeight(dsc_o5s7:GetText())
		this:ClearFocus()
	end)
	...
	-- Chat Options
	ds_TitleString("Reset Chat Position",opt.o5,16,264)
	opt.o5sB = CreateFrame("Button", "dsc_o5sB", opt, "UIPanelButtonTemplate")
	opt.o5sB:SetPoint("TOPLEFT", opt, "TOPLEFT", 25, -983)
	...
	ds_TitleString("Emoji",opt,12,1037)
	opt.o6 = ds_CustomBg(opt,336,600,10,1052)
	...
	opt.o6e1 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e1:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -110)
	opt.o6e1:SetWidth(30)
	opt.o6e1:SetHeight(30)
	opt.o6e1:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\SeemsGoodMan.tga")
	
	ds_DescString("feelsgoodman / fgman",opt.o6,115,99,7)
	opt.o6e2 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e2:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -112)
	opt.o6e2:SetWidth(30)
	opt.o6e2:SetHeight(30)
	opt.o6e2:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\FeelsGoodMan.tga")
	
	ds_DescString("feelsbadmn / fbman",opt.o6,225,99,7)
	opt.o6e3 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e3:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -112)
	opt.o6e3:SetWidth(30)
	opt.o6e3:SetHeight(30)
	opt.o6e3:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\FeelsBadMan.tga")
	
	ds_DescString("Ree / REE",opt.o6,15,154,7)
	opt.o6e4 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e4:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -165)
	opt.o6e4:SetWidth(30)
	opt.o6e4:SetHeight(30)
	opt.o6e4:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Ree.tga")
	
	ds_DescString("LUL / lul",opt.o6,115,154,7)
	opt.o6e5 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e5:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -165)
	opt.o6e5:SetWidth(30)
	opt.o6e5:SetHeight(30)
	opt.o6e5:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\lul.tga")
	
	ds_DescString("OMEGALUL / omegalul",opt.o6,225,154,7)
	opt.o6e6 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e6:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -165)
	opt.o6e6:SetWidth(30)
	opt.o6e6:SetHeight(30)
	opt.o6e6:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Omega.tga")
	
	ds_DescString("MonkaS / monkas",opt.o6,15,209,7)
	opt.o6e7 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e7:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -220)
	opt.o6e7:SetWidth(30)
	opt.o6e7:SetHeight(30)
	opt.o6e7:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\MonkaS.tga")
	
	ds_DescString("WeSmart / wesmart",opt.o6,115,209,7)
	opt.o6e8 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e8:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -220)
	opt.o6e8:SetWidth(30)
	opt.o6e8:SetHeight(30)
	opt.o6e8:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\WeSmart.tga")
	
	ds_DescString("PogChamp / pogchamp",opt.o6,225,209,7)
	opt.o6e9 = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6e9:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -220)
	opt.o6e9:SetWidth(30)
	opt.o6e9:SetHeight(30)
	opt.o6e9:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PogChamp.tga")
	
	ds_DescString("PEP",opt.o6,15,264,7)
	opt.o6eA = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eA:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -275)
	opt.o6eA:SetWidth(30)
	opt.o6eA:SetHeight(30)
	opt.o6eA:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Pep.tga")
	
	ds_DescString("Poggers / poggers",opt.o6,115,264,7)
	opt.o6eB = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eB:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -275)
	opt.o6eB:SetWidth(30)
	opt.o6eB:SetHeight(30)
	opt.o6eB:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Poggers.tga")
	
	ds_DescString("PepeHands / pepehands",opt.o6,225,264,7)
	opt.o6eC = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eC:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -275)
	opt.o6eC:SetWidth(30)
	opt.o6eC:SetHeight(30)
	opt.o6eC:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PepeHands.tga")
	
	ds_DescString("AYY / ayy",opt.o6,15,319,7)
	opt.o6eD = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eD:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -330)
	opt.o6eD:SetWidth(30)
	opt.o6eD:SetHeight(30)
	opt.o6eD:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\ayy.tga")
	
	ds_DescString("NotLikeThis / notlikethis",opt.o6,115,319,7)
	opt.o6eE = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eE:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -330)
	opt.o6eE:SetWidth(30)
	opt.o6eE:SetHeight(30)
	opt.o6eE:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\NotLikeThis.tga")
	
	ds_DescString("Kappa / kappa",opt.o6,225,319,7)
	opt.o6eF = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eF:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -330)
	opt.o6eF:SetWidth(30)
	opt.o6eF:SetHeight(30)
	opt.o6eF:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Kappa.tga")
	
	ds_DescString("CmonBruh / cmonbruh",opt.o6,15,374,7)
	opt.o6eG = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eG:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -385)
	opt.o6eG:SetWidth(30)
	opt.o6eG:SetHeight(30)
	opt.o6eG:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\CmonBruh.tga")
	
	ds_DescString("Thonk / thonk",opt.o6,115,374,7)
	opt.o6eH = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eH:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -385)
	opt.o6eH:SetWidth(30)
	opt.o6eH:SetHeight(30)
	opt.o6eH:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Thonk.tga")
	
	ds_DescString("Wwow / wwow",opt.o6,225,374,7)
	opt.o6eI = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eI:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -385)
	opt.o6eI:SetWidth(30)
	opt.o6eI:SetHeight(30)
	opt.o6eI:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Wwow.tga")
	
	ds_DescString("Jebaited / jebaited",opt.o6,15,429,7)
	opt.o6eJ = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eJ:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -440)
	opt.o6eJ:SetWidth(30)
	opt.o6eJ:SetHeight(30)
	opt.o6eJ:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Jebaited.tga")
	
	ds_DescString("MonkaT / monkat",opt.o6,115,429,7)
	opt.o6eK = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eK:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -440)
	opt.o6eK:SetWidth(30)
	...
	opt.o6eL:SetHeight(30)
	opt.o6eL:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Wwoke.tga")	
	
	ds_DescString("FeelsBruh / feelsbruh",opt.o6,15,484,7)
	opt.o6eM = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eM:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -495)
	opt.o6eM:SetWidth(30)
	opt.o6eM:SetHeight(30)
	opt.o6eM:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\FeelsBruh.tga")
	
	ds_DescString("LULW / lulw",opt.o6,115,484,7)
	opt.o6eN = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eN:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -495)
	opt.o6eN:SetWidth(30)
	opt.o6eN:SetHeight(30)
	opt.o6eN:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\lulw.tga")
	
	ds_DescString("GachiGasm / gachigasm",opt.o6,225,484,7)
	opt.o6eO = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eO:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -495)
	opt.o6eO:SetWidth(30)
	opt.o6eO:SetHeight(30)
	opt.o6eO:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\GachiGasm.tga")	
	
	ds_DescString("PepeEz / pepeez",opt.o6,15,539,7)
	opt.o6eP = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eP:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 20, -550)
	opt.o6eP:SetWidth(30)
	opt.o6eP:SetHeight(30)
	opt.o6eP:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PepeEz.tga")
	
	ds_DescString("PepeGa / pepega",opt.o6,115,539,7)
	opt.o6eR = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eR:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 120, -550)
	opt.o6eR:SetWidth(30)
	opt.o6eR:SetHeight(30)
	opt.o6eR:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\PepeGa.tga")
	
	ds_DescString("Facepalm / facepalm",opt.o6,225,539,7)
	opt.o6eS = opt.o6:CreateTexture(nil, "BACKGROUND")
	opt.o6eS:SetPoint("TOPLEFT", opt.o6 ,"TOPLEFT", 230, -550)
	opt.o6eS:SetWidth(30)
	opt.o6eS:SetHeight(30)
	opt.o6eS:SetTexture("Interface\\AddOns\\DarkShift_Chat\\lib\\emotes\\Facepalm.tga")	
	
	opt.en = opt:CreateTexture(nil, "BACKGROUND")
	opt.en:SetPoint("TOPLEFT", opt.o6 ,"BOTTOMLEFT", 0, 0)
	opt.en:SetWidth(7)
	opt.en:SetHeight(7)
...
function ds_chat_optionsReset()
	
	-- Reset
	ds_conf.chat = nil
	ds_conf.chat = TableDeepCopy(DSC_SKINS_LIST["Simple"])
...
function ds_chat_optionsPosUpd()
